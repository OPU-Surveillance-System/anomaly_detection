...
if __name__ == '__main__':
    ...
    parser.add_argument('--trecord', dest='train_records', type=str, default='data/train.tfrecord', help='Path to trainset tfrecords')
    parser.add_argument('--vrecord', dest='val_records', type=str, default='data/val.tfrecord', help='Path to valset tfrecords')
