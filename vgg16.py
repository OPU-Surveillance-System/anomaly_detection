    ...
    def get_logits(self):
        ...
        with tf.name_scope('vgg') as scope:
            ...
            with tf.name_scope('fc1') as scope:
                ...
                dropedfc1 = tf.contrib.layers.dropout(self.fc1, keep_prob=0.5, is_training=self.is_training)
            ...
            with tf.name_scope('fc2') as scope:
                ...
                dropedfc2 = tf.contrib.layers.dropout(self.fc2, keep_prob=0.5, is_training=self.is_training)
